...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .save{position:absolute;right:10px;top:10px;width:34px;height:34px;border-radius:99px;border:0;background:rgba(255,255,255,.85);backdrop-filter:blur(4px);cursor:pointer;display:flex;align-items:center;justify-content:center;transition:transform .15s,background .15s;z-index:2}
